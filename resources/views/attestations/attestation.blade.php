  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
        <div class="card">
          ...
          <div class="card-body">
            <p>Je soussigné(e),Monsieur Bahae-Eddin Halim, agissant en qualité de {{"..........."}} de l'entreprise DSI MEN dont le siège social se situe au Av. Ibn Rochd, Rabat , 
              certifie par la présente avoir accueilli au sein de l'entreprise Monsieur {{$firstName??'.......' }} {{$lastName??'..............'}} , domicilié(e) a Rabat pour un stage destiné
               à lui faire découvrir le métier de Developpement.</p>
            <p>Je précise, par la présente, que ce stage s'est déroulé du {{$startDate??'.......'}} au {{$endDate??'..........'}}. 
              Tout au long de cette période, Monsieur {{$firstName??'............' }} {{$lastName??'..............'}}  a su répondre à ses obligations de stagiaire,
